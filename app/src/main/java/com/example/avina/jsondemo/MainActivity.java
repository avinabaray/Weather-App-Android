package com.example.avina.jsondemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void fetchWeather(View view)
    {
        ...
        APIdownload apicontent = new APIdownload();
            apicontent.execute("http://api.openweathermap.org/data/2.5/weather?q="+cityName+"&appid="+ API_KEY);	// Enter a valid API_KEY of "openweather.org" for the app to function
        } catch (Exception e)
        {
            e.printStackTrace();
